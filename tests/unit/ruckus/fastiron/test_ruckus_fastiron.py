...
@pytest.mark.parametrize(
    "priv_pattern",
    [
        ("exec", "ICX7150-24P Switch>"),
        ("privilege_exec", "ICX7150-24P Switch#"),
        ("configuration", "ICX7150-24P Switch(config)#"),
        ("configuration", "ICX7150-24P Switch(config-if-e1000-1/1/1)#"),
        ("exec", "SSH@ICX7150-24P Switch>"),
        ("privilege_exec", "SSH@ICX7150-24P Switch#"),
        ("configuration", "SSH@ICX7150-24P Switch(config)#"),
        ("configuration", "SSH@ICX7150-24P Switch(config-if-e1000-1/1/1)#"),
    ...
    ids=[
        ...
        "base_prompt_with_space_privilege_exec",
        "base_prompt_with_space_configuration",
        "base_prompt_with_space_configuration_interface",
        "ssh_prompt_with_space_exec",
        "ssh_prompt_with_space_privilege_exec",
        "ssh_prompt_with_space_configuration",
        "ssh_prompt_with_space_configuration_interface",
        "base_prompt_exec",
