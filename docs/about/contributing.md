...
Thanks for thinking about contributing to scrapli-community! Contributions are not expected, but are quite welcome.
...
- Please check out the `User Guide` which explains a bit about what a "Platform" is, why you may want to build one, 
  and a bit about how to do so!
